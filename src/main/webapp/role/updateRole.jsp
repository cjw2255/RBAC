    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.html">角色维护</a></div>
        </div>
			  ...
			  <div class="panel-body">
				<form role="form" id="from1">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="rname" name="rname" value="${role.rname }">
				  </div>
            ...
            $(function () {
			    ...
			    $("#updateBtn").click(function(){
			    	...
			    	$.ajax({
			    		...
			    		url:"updateRole",
			    		type:"post",
			    		data:{"rid":$("#rid").val(),"rname":rnameVal},
			    		error:function(){
			    			alert("error");
			    		},
