			  ...
			  <div class="panel-body">
				<form role="form" id="from1">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="uaccount" name="uaccount" value="${users.uaccount }">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">用户名称</label>
					<input type="text" class="form-control" id="uname" name="uname" value="${users.uname }">
				  </div>
				  <div class="form-group">
					<label for="exampleInputEmail1">邮箱地址</label>
					<input type="email" class="form-control" id="uemail" name="uemail" value="${users.uemail }">
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#updateBtn").click(function(){
			    	...
			    	if (uaccountVal=="") {
			    		layer.msg("账户不能为空！", {time:1000, icon:5, shift:6}, function(){});
			    		return;
					}
			    	if (unameVal=="") {
			    	...
			    	if (uemailVal=="") {
			    		layer.msg("邮箱地址不能为空！", {time:1000, icon:5, shift:6}, function(){});
			    		return;
					}
			    	$.ajax({
			    		cache:false,
			    		url:"updateUser",
			    		type:"post",
			    		data:{"uid":$("#uid").val(),"uaccount":uaccountVal,"uname":unameVal,"uemail":uemailVal},
			    		error:function(){
			    			alert("error");
			    		},
			    		success:function(result){
			    			if (result.flag) {
			    				layer.msg("修改成功！", {time:5000, icon:6, shift:6}, function(){});
								window.location.href="index";
			    			}else{
								layer.msg("修改失败！", {time:1000, icon:2, shift:6}, function(){});
							}
			    		}
			    	});
			    });
